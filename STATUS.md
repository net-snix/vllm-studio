...
- [x] Inspect stale generated comments in controller log routes.
- [x] Remove stale wrapper JSDoc from `controller/src/modules/system/logs-routes.ts` without behavior changes.
- [x] Validate removed stale log-route comments do not remain.
