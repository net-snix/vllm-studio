...
- [x] Inspect controller integration coverage gaps.
- [x] Add mocked-fetch integration coverage for `/v1/huggingface/models` list, exact-match, normalization, and observability behavior.
